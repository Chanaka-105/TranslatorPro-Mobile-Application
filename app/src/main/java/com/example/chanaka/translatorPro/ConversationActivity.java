...
//        ImageView mImageKeyboardTo = (ImageView) findViewById(R.id.image_keyboard_to);          //      Input Keyboard button (To)
       ...
       // ImageView mImageMicTo = (ImageView) findViewById(R.id.image_mic_to);                    //      Input Mic button (To)
        ...
        RelativeLayout no_internet_connection=(RelativeLayout)findViewById(R.id.no_internet_connection);
        LinearLayout lnr1=(LinearLayout)findViewById(R.id.lnr_language);
...
//
        ...
        actionbar.setTitle("New Conversation");
...
//            });
            //New LinearLayout
            final LinearLayout keyboard_popup=(LinearLayout) findViewById(R.id.keyboard_popup);
            keyboard_popup.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    keyboard_popup.setVisibility(View.GONE);
