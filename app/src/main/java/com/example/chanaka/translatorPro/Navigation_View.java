...
import static com.example.chanaka.translatorPro.GlobalVars.BASE_REQ_URL;
//import static com.example.apaar97.translate.GlobalVars.DEFAULT_LANG_POS;
//import static com.example.apaar97.translate.GlobalVars.DEFUALT_LANG_TO;
import static com.example.chanaka.translatorPro.GlobalVars.LANGUAGE_CODES;


public class Navigation_View extends AppCompatActivity implements  TextToSpeech.OnInitListener {
    ...
    private FloatingActionButton speech_to_txt;
    private RelativeLayout no_internet_connection;
    /** This is translation part*/
    public static final String LOG_TAG = Navigation_View.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
           setContentView(R.layout.activity_navigation__view);



       /**This is Navigation Operations Code*/
       no_internet_connection=(RelativeLayout)findViewById(R.id.no_internet_connection);
        ...
        Button btn_conversation=(Button)findViewById(R.id.conversation);
        //conversation=(FloatingActionButton)findViewById(R.id.conversation);
        speech_to_txt=(FloatingActionButton)findViewById(R.id.speech_to_text);
//        progressBar=(ProgressBar)findViewById(R.id.progressBar);

        /**This is Toolbar+ActionBar*/
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()){
                            case R.id.nav_about_us:
                                AboutUs identifyGroupDialog = new AboutUs(Navigation_View.this);
                            ...
                            case R.id.nav_exit:
                                ...
                                break;
                            case R.id.nav_share:
                                Share shareDialog = new Share(Navigation_View.this);
                                shareDialog.show();
                                break;
                        }
                        return true;
        ...
        /**This is the translation code starts*/
        ...
        process_tts = new Dialog(Navigation_View.this);
        ...
        btn_conversation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Navigation_View.this,ConversationActivity.class);
        ...
        refresh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(Navigation_View.this,Navigation_View.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
        ...
        if (!isOnline()) {
           ...
           no_internet_connection.setVisibility(View.GONE);
            //  GET LANGUAGES LIST
            new Navigation_View.GetLanguages().execute();

            //  SPEECH TO TEXT
            speech_to_txt.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            mButtonTranslate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    new Navigation_View.TranslateText().execute(input);
                    InputMethodManager imm =(InputMethodManager) getApplicationContext().getSystemService(Navigation_View.INPUT_METHOD_SERVICE);
            ...
            mSpinnerLanguageFrom.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    int selectedPosition=mSpinnerLanguageFrom.getSelectedItemPosition();
            ...
            mSpinnerLanguageTo.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    SharedPreferences.Editor editor=getPreferences(0).edit();
                    int selectedPosition=mSpinnerLanguageTo.getSelectedItemPosition();
                    editor.putInt("spinnerSelection2",selectedPosition);
                    editor.apply();
                }
                @Override
                public void onNothingSelected(AdapterView<?> parent) {
        ...
        switch (requestCode) {
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                     ...
                     */
                    final Dialog match_text_dialog = new Dialog(Navigation_View.this);
    ...
    private void speakOut(){
        ...
        if (result == TextToSpeech.LANG_MISSING_DATA ){
            ...
            Toast.makeText(getApplicationContext(),getString(R.string.language_not_supported),Toast.LENGTH_SHORT).show();
        } else { if(mTextTranslated.getText().toString().isEmpty()){
    ...
    private class GetLanguages extends AsyncTask<Void,Void,ArrayList<String>>{
        ...
        protected void onPostExecute(ArrayList<String> result) {
            if (activityRunning) {
                ArrayAdapter<String> adapter = new ArrayAdapter<>(Navigation_View.this, android.R.layout.simple_spinner_item, result);
                ...
                mSpinnerLanguageFrom.setSelection(pref.getInt("spinnerSelection",0));
                mSpinnerLanguageTo.setSelection(pref.getInt("spinnerSelection2",0));
            }
        }
    }
    ...
    private boolean doubleBackprssToExitPressedOnce;
    private Handler mHandler= new Handler();
    private final Runnable mRunnable=new Runnable() {
        @Override
        public void run() {
            doubleBackprssToExitPressedOnce=false;
    ...
    public void onBackPressed() {
        if(doubleBackprssToExitPressedOnce){
            super.onBackPressed();
            return;
        }
        this.doubleBackprssToExitPressedOnce=true;
